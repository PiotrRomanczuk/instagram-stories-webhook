			...
			<div className='max-w-4xl mx-auto space-y-8'>
				<div>
					...
					<p className='mt-2 text-slate-500 font-medium'>
						Directly test Instagram publishing. This bypasses the scheduler and
						database completely to isolate API issues.
					</p>
				</div>
				...
				<div className='p-6 bg-amber-50 border border-amber-200 rounded-2xl'>
					...
					<p className='text-amber-700 text-sm'>
						This is a manual debug tool. Use it only to verify that your
						Instagram connection is working. Posts made here will NOT be tracked
						in your schedule history.
					</p>
				</div>
			</div>
		</main>
