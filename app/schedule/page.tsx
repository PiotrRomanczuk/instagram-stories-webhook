                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                    <div>
                        ...
                        <h1 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight">
                            Schedule <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">Manager</span>
                        </h1>
                        <p className="mt-2 text-slate-500 font-medium max-w-xl">
                            Schedule Instagram stories to be published automatically at specific times.
                        </p>
                    </div>

                    <div className="flex items-center gap-3 bg-white px-4 py-2 rounded-2xl shadow-sm border border-slate-100">
                        <div className="w-2 h-2 rounded-full bg-indigo-500 animate-pulse"></div>
                        <span className="text-xs font-black text-slate-600 uppercase tracking-widest">Scheduler Active</span>
                    </div>
                </div>
