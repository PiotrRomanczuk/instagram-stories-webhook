			...
			<Table>
				<TableHeader>
					<TableRow className="border-gray-200 hover:bg-transparent">
						<TableHead className="w-20 text-gray-500">Image</TableHead>
						<TableHead className="text-gray-500">Caption</TableHead>
						<TableHead className="w-24 text-gray-500">Status</TableHead>
						<TableHead className="w-32 text-gray-500">Date</TableHead>
						<TableHead className="w-20 text-gray-500">Actions</TableHead>
					</TableRow>
				</TableHeader>
				<TableBody>
...
function EmptyState() {
	return (
		<div className="flex flex-col items-center justify-center py-16 text-center">
			<div className="rounded-full bg-gray-100 border border-gray-200 p-6">
				<List className="h-10 w-10 text-gray-500" />
			</div>
			<h3 className="mt-6 text-xl font-semibold text-gray-900">No submissions yet</h3>
	...
	if (!hasValidUrl || error) {
		return (
			<div className="flex h-12 w-12 items-center justify-center rounded bg-gray-200">
				<ImageOff className="h-5 w-5 text-gray-500 opacity-50" />
			</div>
		);
	}
			...
			<div className="hidden sm:flex justify-end">
				...
				>
					<ToggleGroupItem
						...
						className="data-[state=on]:bg-[var(--sf-primary)] data-[state=on]:text-white text-gray-500 hover:text-gray-900"
					>
							...
							{submissions.map((submission) => (
								...
								>
									...
									<TableCell className="max-w-xs truncate text-gray-900">
										{submission.caption || <span className="text-gray-500">No caption</span>}
									</TableCell>
									<TableCell>
