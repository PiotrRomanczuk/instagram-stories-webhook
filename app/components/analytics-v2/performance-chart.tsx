		...
		<Card className={className}>
			<CardContent className="p-6">
				<div className="mb-4 flex flex-wrap items-start justify-between gap-3">
					<div>
						...
						<p className="text-sm text-muted-foreground">
							Daily counts of archived stories, drafts pushed to TT inbox, and drafts
							that reached published status.
						</p>
					</div>
				...
				<div className="relative">
					...
					>
						{/* Grid lines (theme-aware via currentColor) */}
					...
					{hovered !== null && data[hovered] && (
						<div
							className={cn(
								...
								'whitespace-nowrap rounded-md border bg-popover px-3 py-2 text-xs shadow-lg',
							)}
							style={{
