            ...
            {isPreviewMode && (
                <div className="bg-gradient-to-br from-slate-100 to-slate-200 rounded-3xl p-8 flex flex-col lg:flex-row items-center justify-center gap-8">
                    ...
                    <div className="flex flex-col items-center gap-3">
                        <h3 className="text-sm font-bold text-slate-600 uppercase tracking-wider">What you upload</h3>
                    ...
                    {/* Phone Mockup */}
                    <div className="flex flex-col items-center gap-3">
                        <h3 className="text-sm font-bold text-slate-600 uppercase tracking-wider">What followers see</h3>
                        <div className="relative">
                            {/* iPhone Bezel */}
                            <div className="relative bg-slate-900 rounded-[3rem] p-3 shadow-2xl" style={{ width: '280px', height: '560px' }}>
                                {/* Dynamic Island */}
                                ...
                                <div className="relative w-full h-full bg-black rounded-[2.5rem] overflow-hidden">
                                    ...
                                    <div className="relative w-full h-full">
                                        ...
                                        <div className="absolute top-4 left-4 right-4 flex items-center gap-2 z-20">
                                            ...
                                            <span className="text-white font-bold text-sm drop-shadow-lg">your_account</span>
                                                ...
                                                {hashtagTags.length > 0 && (
                                                    <div className="flex flex-wrap gap-1.5">
                                                        {hashtagTags.slice(0, 5).map((tag, i) => (
                                                            <span key={i} className="text-blue-300 text-xs font-medium drop-shadow">
                                                                #{tag}
                                                            </span>
                                                        ))}
                ...
                <div className="bg-indigo-50 border border-indigo-100 rounded-xl p-4 flex items-start gap-3">
                    ...
                    <div className="text-sm text-indigo-900">
                        ...
                        <ul className="text-xs text-indigo-700 space-y-1">
                            <li>• Stories are displayed in 9:16 aspect ratio (full screen vertical)</li>
                            <li>• Captions appear at the bottom with subtle shadow for readability</li>
                            <li>• User tags show in the center when tapped</li>
                            <li>• First 3 lines of caption are visible before "See more" link</li>
                        </ul>
                    </div>
                </div>
            )}
