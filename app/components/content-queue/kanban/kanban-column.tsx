		...
		<div className="kanban-column flex flex-col gap-4 min-w-[280px] max-w-[320px]">
			...
			<div className="flex flex-col gap-3 overflow-y-auto pr-1 flex-1">
				{items.length > 0 ? (
					...
					<div className="border-2 border-dashed border-gray-200 rounded-xl p-6 flex flex-col items-center justify-center text-center min-h-[200px] opacity-50">
				...
				{items.length > 0 && (
					<div className="border-2 border-dashed border-gray-200/30 rounded-xl p-4 opacity-0 hover:opacity-100 transition-opacity">
